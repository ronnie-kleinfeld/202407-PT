...
function u(t, e) {
    return null != t && null != e && t.getFullYear() === e.getFullYear() && t.getMonth() === e.getMonth() && t.getDate() === e.getDate()
}
...
const w = ({
...
}, a.buttonLabel, o && t("span", null, ", ", a.selectedDateMessage, " ", o)))),
    k = ({
        focusedDay: e,
        today: a,
        day: i,
    ...
    D = ({
        ...
        const w = new Date,
            D = function (t, e = r.Monday) {
                return function (t, e) {
                    const a = [];
                    let i = t;
                    for (; !u(i, e);) a.push(i), i = c(i, 1);
                    return a.push(i), a
                }(h(b(t), e), p(_(t), e))
            }(a, d);
        return t("table", {
            ...
            onFocusin: y,
            onMouseDown: x
        }, t("thead", null, t("tr", null, (M = d, C = e => t("th", {
            ...
            class: "duet-date__vhidden"
        }, e)), (z = o.dayNames).map(((t, e) => C(z[(e + M) % z.length])))))), t("tbody", null, function (t) {
            const e = [];
            ...
            role: "gridcell",
            "aria-selected": u(i, e) ? "true" : void 0
        }, t(k, {
            day: i,
            today: w,
            focusedDay: a,
    ...
    F = class {
        constructor(t) {
            e(this, t), this.duetChange = a(this, "duetChange", 7), this.duetBlur = a(this, "duetBlur", 7), this.duetFocus = a(this, "duetFocus", 7), this.monthSelectId = y("DuetDateMonth"), this.yearSelectId = y("DuetDateYear"), this.dialogLabelId = y("DuetDateLabel"), this.initialTouchX = null, this.initialTouchY = null, this.activeFocus = !1, this.focusedDay = new Date, this.open = !1, this.name = "date", this.identifier = "", this.disabled = !1, this.direction = "right", this.required = !1, this.value = "", this.min = "", this.max = "", this.firstDayOfWeek = r.Monday, this.localization = z, this.dateAdapter = M, this.enableActiveFocus = () => {
                this.activeFocus = !0
                ...
                m(e, n(this.min), n(this.max)) && (e.getMonth() === this.focusedDay.getMonth() ? (this.setValue(e), this.hide()) : this.setFocusedDay(e))
                ...
                const e = t.target;
                e.value = e.value.replace(C, "");
                const a = this.dateAdapter.parse(e.value, s);
                (a || "" === e.value) && this.setValue(a)
        ...
        handleDocumentClick(t) {
            if (!this.open) return;
            const e = t.target;
            this.dialogWrapperNode.contains(e) || this.datePickerButton.contains(e) || this.hide(!1)
        }
        async setFocus() {
            return this.datePickerInput.focus()
        }
        async show() {
            this.open = !0, this.setFocusedDay(n(this.value) || new Date), clearTimeout(this.focusTimeoutId), this.focusTimeoutId = setTimeout((() => this.monthSelectNode.focus()), 300)
        }
        async hide(t = !0) {
            this.open = !1, clearTimeout(this.focusTimeoutId), t && setTimeout((() => this.datePickerButton.focus()), 500)
        }
        addDays(t) {
            this.setFocusedDay(c(this.focusedDay, t))
        }
        addMonths(t) {
        ...
        startOfWeek() {
            this.setFocusedDay(h(this.focusedDay, this.firstDayOfWeek))
        }
        endOfWeek() {
            this.setFocusedDay(p(this.focusedDay, this.firstDayOfWeek))
        }
        setMonth(t) {
            const e = v(b(this.focusedDay), t),
                a = _(e),
                i = v(this.focusedDay, t);
            this.setFocusedDay(g(i, e, a))
        }
        setYear(t) {
            const e = f(b(this.focusedDay), t),
                a = _(e),
                i = f(this.focusedDay, t);
            this.setFocusedDay(g(i, e, a))
        }
        setFocusedDay(t) {
            this.focusedDay = g(t, n(this.min), n(this.max))
        }
        setValue(t) {
        ...
        render() {
            ...
            let h = o - 100,
                p = o + 100;
            return s && (h = Math.max(h, s.getFullYear())), l && (p = Math.min(p, l.getFullYear())), t(i, null, t("div", {
                class: "duet-date"
            }, t(w, {
                value: this.value,
                formattedValue: a,
                ...
                class: "duet-date__vhidden"
            }, this.localization.nextMonthLabel)))), t(D, {
                selectedDate: e,
