Module Common
    ...
    Public AllFiles_Js As String() = {"", "Kiosk", "Grid", "Tab", "Date", "Num", "Time", "Select", "Submit", "Dialog", "Focus", "Print", "Lang", "Resol"}
    ...
    Public AllFields_FlexCombo1 As String() = {"hTbno", "hCurValue", "hTarget", "hPer", "hPfk", "hWidth1", "hWidth2", "hHeight1", "hOrderBy", "sMaxRows"}
    ...
    Public AllHiddens As String() = {"fld", "fpch", "find", "fcmd", "cur", "wait", "resW", "resH", "result100", "text", "client"}
