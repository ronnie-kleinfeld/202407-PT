...
namespace Comtec.AS400XML.Output {
    public class AS400XmlParser {
        ...
        public int DeserializeFilesInDirectory<T>(string directory) where T : ScreenOutputXmlRoot {
            ...
            foreach (string xmlFilePath in xmlFiles) {
                try {
                    ...
                    if (AppConfigHandler.Data.AS400Xml.DeleteInvalidFiles) {
        ...
        public XmlFileModel DeserializeFilePath<T>(string xmlFilePath) where T : ScreenOutputXmlRoot {
            XmlFileModel xmlFileModel = new XmlFileModel(xmlFilePath);

            xmlFileModel.RawXML = File.ReadAllText(xmlFilePath);
            AS400XmlOutputModel as400XmlOutput = DeserializeString<T>(xmlFileModel.RawXML);
            xmlFileModel.ScreenXmlRoot = as400XmlOutput.ScreenXmlRoot;
