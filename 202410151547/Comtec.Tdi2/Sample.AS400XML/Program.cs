using Comtec.AS400XML.Input;
using Comtec.AS400XML.Input.Model.Screen;
using Comtec.AS400XML.Output;
...
namespace Sample.AS400XML {
    internal class Program {
        internal static void Main(string[] args) {
            ...
            string str1 = AllowedDataHandler.Instance.ToString();

            DateTime dt1 = DateTime.Now;
            AS400XmlBuilder as400XmlBuilder = new AS400XmlBuilder();
            List<CInputXmlElement> cInputXmlElementList = new List<CInputXmlElement>();
            List<FInputXmlElement> fInputXmlElementList =
            [
                new FInputXmlElement("LOPT01    ", "0001", " ", " "),
                new FInputXmlElement("LOPT02    ", "0002", " ", " "),
                new FInputXmlElement("LOPT03    ", "0003", " ", " "),
            ];
            ScreenInputXmlRoot screenInputXmlRoot = new ScreenInputXmlRoot(
                new SInputXmlElement("HFFLNAVFM ", "ROPTION   ", "0000000000", "0000", "59"),
                cInputXmlElementList,
                fInputXmlElementList);
            as400XmlBuilder.WriteToFile(screenInputXmlRoot, @"C:\Users\ronnie.k\Downloads\empty.xml");
            string xmlString = as400XmlBuilder.ConvertToString(screenInputXmlRoot, true);
            ...
            //string xmlDirectory = "C:\\";
            //string xmlDirectory = "C:\\Work_Tfs";
            string xmlDirectory = "\\\\172.17.17.2\\ComDisplay_Sites";
            ...
            int counter = as400XmlParser.DeserializeDirectoriesInDirectory<ScreenOutputXmlRoot>(xmlDirectory, "TdiCheck");
            LogHelper.WriteInformation(MethodBase.GetCurrentMethod(), $"{counter} files");

            //int counter = as400XmlParser.DeserializeFilesInDirectory<ScreenOutputXmlRoot>(xmlDirectory);
            //LogHelper.WriteInformation(MethodBase.GetCurrentMethod(), $"{counter} files");
