...
namespace Comtec.BE.LogEx {
    public static class LogHelper {
        ...
        public static void Init(LogConfigData logConfigData) {
            logConfigData.LogFileDirectory = logConfigData.LogFileDirectory == "" ? "C:\\Tdi2Logs" : logConfigData.LogFileDirectory;
            logConfigData.LogFileName = logConfigData.LogFileName == "" ? "log.txt" : logConfigData.LogFileName;
            ...
            if (logConfigData.LogToConsole && logConfigData.LogToFile) {
                ...
                LogHelper.WriteInformation(MethodBase.GetCurrentMethod(), $"Log Path: {logConfigData.LogPath}");
