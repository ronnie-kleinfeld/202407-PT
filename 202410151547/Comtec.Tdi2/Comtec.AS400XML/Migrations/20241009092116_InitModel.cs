        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PfkXmlAttribute = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EnvironmentMachineName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EnvironmentUserName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EnviromentUserDomainName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GetFullPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AS400XmlOutput", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AS400XmlOutput_ScreenOutputXmlRoot_ScreenXmlRootId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AS400XmlOutput_ScreenXmlRootId",
                table: "AS400XmlOutput",
