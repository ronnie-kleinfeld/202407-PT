...
namespace Comtec.AS400XML.Output.Model.Screen {
    public class FXmlElement : BaseAllowedValuesValidationModel {
        ...
        /// <summary>
        /// Indicates the name used in AS400 to identify the field
        /// </summary>
        ...
        /// <summary>
        /// Determnines the index in the TAB order for this field
        /// </summary>
        ...
        [XmlAttribute("pfk"), MaxLength(1000), AS400XmlAllowedValues]
        public string? PfkXmlAttribute {
            get; set;
        }
