...
namespace Comtec.AS400XML.Input.Model.Screen {
    public class SInputXmlElement {
        ...
        public SInputXmlElement() {
        }
        public SInputXmlElement(string filXmlAttribute, string recXmlAttribute, string fldXmlAttribute, string findXmlAttribute, string fcmdXmlAttribute) {
            FilXmlAttribute = filXmlAttribute;
            RecXmlAttribute = recXmlAttribute;
            FldXmlAttribute = fldXmlAttribute;
            FindXmlAttribute = findXmlAttribute;
            FcmdXmlAttribute = fcmdXmlAttribute;
        }
    }
}